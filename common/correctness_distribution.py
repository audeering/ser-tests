r"""Test correctness of distribution.

The predictons returned by a model
should match the actual distributions
as closly as possible over a high number of calls.
"""
import operator
import os
import typing
...
from common.plots import plot_distribution
